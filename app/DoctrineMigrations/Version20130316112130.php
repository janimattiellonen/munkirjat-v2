 ...
 */
class Version20130316112130 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE book CHANGE is_read is_read TINYINT(1) NOT NULL");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE book CHANGE is_read is_read INT NOT NULL");
    }
}
