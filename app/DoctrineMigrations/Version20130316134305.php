 ...
 */
class Version20130316134305 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE book CHANGE isbn isbn VARCHAR(40) DEFAULT NULL, CHANGE started_reading started_reading DATETIME DEFAULT NULL, CHANGE finished_reading finished_reading DATETIME DEFAULT NULL, CHANGE rating rating DOUBLE PRECISION DEFAULT NULL");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE book CHANGE isbn isbn VARCHAR(40) NOT NULL, CHANGE started_reading started_reading DATETIME NOT NULL, CHANGE finished_reading finished_reading DATETIME NOT NULL, CHANGE rating rating DOUBLE PRECISION NOT NULL");
    }
}
