...
--
-- Host: localhost    Database: munkirjatv3-vagrant
-- ------------------------------------------------------
...
CREATE TABLE `book_genre` (
  ...
  CONSTRAINT `FK_8D9226814296D31F` FOREIGN KEY (`genre_id`) REFERENCES `genre` (`id`),
...
INSERT INTO `fos_user` VALUES (1,'munkirjat','munkirjat','munkirjat@example.com','munkirjat@example.com',1,'qpzklhghexw40w4oo0ow04cokso8848','5Bvh1ldnws9rGWfU7mLUo956X1Er0dq48hC7sfqk7VQwsyoBl+vKNN6RordSZ9cRNOYVTlyblR3naX6ISYWKyA==',NULL,0,0,NULL,NULL,NULL,'a:1:{i:0;s:10:\"ROLE_ADMIN\";}',0,NULL);
...
INSERT INTO `migration_versions` VALUES ('20130623225328'),('20130820210118');
...
--
-- Dumping data for table `xi_tag`
--

LOCK TABLES `xi_tag` WRITE;
/*!40000 ALTER TABLE `xi_tag` DISABLE KEYS */;
/*!40000 ALTER TABLE `xi_tag` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `xi_tagging` (
  ...
  KEY `IDX_431075D2BAD26311` (`tag_id`),
  CONSTRAINT `FK_431075D2BAD26311` FOREIGN KEY (`tag_id`) REFERENCES `xi_tag` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `xi_tagging`
--

LOCK TABLES `xi_tagging` WRITE;
/*!40000 ALTER TABLE `xi_tagging` DISABLE KEYS */;
/*!40000 ALTER TABLE `xi_tagging` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-08-30 19:35:44
